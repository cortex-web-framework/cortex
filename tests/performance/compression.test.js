...
function createMockReq(acceptEncoding) {
    return {
        get: (header) => header === 'Accept-Encoding' ? acceptEncoding : undefined,
        acceptsEncodings: (encoding) => acceptEncoding?.includes(encoding) || false,
        headers: {
...
function createMockRes() {
    ...
    return {
        ...
        writeHead: (code, messageOrHeaders, headersArg) => {
            statusCode = code;
